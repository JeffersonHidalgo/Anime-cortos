    ...
    <div class="navbar-lateral full-reset">
        ...
        <div class="full-reset container-menu-movile custom-scroll-containers">
            ...
            <div class="full-reset" style="background-color:#2B3D51; padding: 10px 0; color:#fff;">
                ...
                <p class="text-center" style="padding-top: 15px;"><font size="4" face="Algerian">Anime corto</font></p>
            </div>
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                           <li><a href="./paginaanime/demon-king-cademy/inicio.php"><i class="zmdi zmdi-movie-alt"></i>&nbsp;&nbsp;<i> Demon King academy</i></a></li>
                            ...
                            <li><a href="esperamusical.php"><i class="zmdi zmdi-movie-alt"></i>&nbsp;&nbsp; <i> tatoeba last dungeon</i></a></li>
                    	 ...
                    	 <li><a href="index.php"><i class="zmdi zmdi-movie"></i>&nbsp;&nbsp;  Cerrar</a></li>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles"><center><font size="10" face="Algerian">Anime corto</font></center></h1>
            </div>
        </div>
...
<a href="./paginaanime/demon-king-cademy/inicio.php"><img src="./img/6.jpg" alt="Biblioteca" class="img-responsive center-box" style="width:20%; border-radius:10px; display:inline-block;"></a>
<a href="./paginaanime/no-game-no-life/inicio.php"><img src="./img/5.jpg" alt="Biblioteca" class="img-responsive center-box" style="width:20%; border-radius:10px; display:inline-block;"></a>
<a href="./paginaanime/mortal/inicio.php"><img src="./img/2.jpg" alt="Biblioteca" class="img-responsive center-box" style="width:20%; border-radius:10px; display:inline-block;"></a>
<a href="./paginaanime/smarfon/inicio.php"><img src="./img/4.jpg" alt="Biblioteca" class="img-responsive center-box" style="width:20%; border-radius:10px; display:inline-block;"></a>
